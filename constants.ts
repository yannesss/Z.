...
export const TRANSLATIONS = {
  en: {
    ...
    smartEntryTitle: 'Gemini Smart Assistant',
    smartEntryHint: 'Type freely like "Spent 500 on office supplies yesterday" or "Received 10000 deposit from Client X".',
    smartEntryPlaceholder: 'Describe your transaction...',
    ...
    errorSmart: 'Could not understand that transaction. Please try again.',
  ...
  zh: {
    ...
    totalExpense: '總支出',
    netIncome: '淨收入',
    smartEntryTitle: 'Gemini 智能助手',
    smartEntryHint: '隨意輸入，例如「昨天買文具用了500元」或「收到客戶X訂金10000元」。',
    smartEntryPlaceholder: '描述您的交易...',
    smartEntryButton: '分析',
